    ...
    <section id="left">
      ...
      <article class="info">
        ...
        <ul>
          ...
          <li>I am able to <strong>communicate well</strong> with others via <strong>phone</strong> and <strong>face-to-face</strong>, given my experience with volunteering and previous work experience.</li>
        </ul>
      </article>
    </section>
