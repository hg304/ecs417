...
<body>
  ...
  <section>
    ...
    <?php
      ...
      $_SESSION["time"] = new Date("d/m/y g:i A");

      echo "<h3><style='font-family: Tahoma; text-align: right; color: white;'>", $_SESSION["title"], "</h3><p><style='color: white; font-family: Tahoma;'>", $_SESSION["description"], "</p><p><br><small style='color:white; font-family:Tahoma;'>Posted: ", $_SESSION["time"], "</small></p><hr>";
      include("config.php");
