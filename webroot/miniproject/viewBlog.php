      ...
      if ($_POST["months"] == null)
      {
        ...
        if (!$res)
         ...
         for ($i = $rows; $i > 0; $i--)
         {
           ...
           echo "<h3><style='font-family: Tahoma; text-align: center; float: right; color: white;'>", $result["title"], "</h3><p><style='color: white; font-family: Tahoma;'>", $result["description"], "</p><p><br><small style='color:white; font-family:Tahoma;'>Posted: ", date("d/m/y g:i A", strtotime($result["datepost"])), "</small></p><hr>";
         }
       }
       else
       {
